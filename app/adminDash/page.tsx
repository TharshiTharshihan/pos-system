...
function Page() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <aside
        className={`fixed bg-gradient-to-b from-green-900 to-green-300 top-0 left-0 z-40 w-64 h-full transition-transform duration-300
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap" key="products">
                  Products
                </span>
              </a>
            </li>
